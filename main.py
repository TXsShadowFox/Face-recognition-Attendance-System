...
datef = tk.Label(window, text=day + "-" + mont[month] + "-" + year,
                 fg="#ff61e5", bg="green", width=20, font=('comic', 15, ' bold '))
...
txt.place(x=30, y=88)
txt_warning = tk.Label(frame2, text="", fg="red", bg="#c79cff", font=('comic', 10, ' bold '))
...
txt2_warning = tk.Label(frame2, text="", fg="red", bg="#c79cff", font=('comic', 10, ' bold '))
...
message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile", bg="#c79cff",
                    fg="black", width=39, height=1, activebackground="#3ffc00",
                    font=('comic', 15, ' bold '))
